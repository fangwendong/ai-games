...
- [Bar-close parity correction - 2026-07-29](research/bar-close-parity-correction-2026-07-29.md):
  five-minute signal-availability fix, corrected V2/V3/V4 results, intraday
  replay, and bounded candidate rejection evidence.
- [Recent-regime rotation optimization - 2026-07-29](research/recent-regime-optimization-2026-07-29.md):
  superseded pre-parity investigation retained for audit history.
